"""One-shot permission reconnaissance for canonical airport fallbacks."""
...
MANIFEST = HERE / "airport_permission_manifest.csv"
RESULTS = HERE / "airport_permission_results.csv"
CACHE = HERE / "raw_cache" / "permission_airports"
SPACING_SECONDS = 6.7
