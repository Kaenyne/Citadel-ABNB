...
- 12:36 A17 response done (B11 0.11 immaterial; B12 0.49 literal / 0.36 material EV -$1.9 material; B13 0.31 EV -$2.3 material; A17 DONE). CONVENTION NOTE for SYNTHESIS: R16 books joint-solve + Feb reaction (+$11, EV +$3.4) while B13 books joint-solve only (-$7.5, EV -$2.3); pick one (recommend joint-solve only, mirror pair +$2.3/-$2.3 on R16's 0.31/B13's 0.31). Running: A19 audit (Opus).
