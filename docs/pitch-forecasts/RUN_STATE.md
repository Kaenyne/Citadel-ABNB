...
- 00:10 A06 forecast done on Fable (S01: unconditional p50 -2.9%, P(<=-8) 0.29, P(<=-5) 0.41, P(>=+5) 0.20; base-case cell p50 -8.6%, P(<=-8) 0.53; event sd 9.0-9.5). A09 forecast (R01-R03) launched on Fable. Running: A05, A07, A08, A09; Codex audit A01 (since 23:03).
