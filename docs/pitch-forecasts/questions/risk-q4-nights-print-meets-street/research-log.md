...
| 10 | Kalshi KXABNBA-27FEBNEB (FY26 nights & experiences booked), 2026-09-17T07:55:03Z: >565m bid 0.79 / ask 0.99, >570m 0.63/0.99, >575m 0.36/0.76, >580m 0.19/0.99, >585m 0.10/0.16, >590m 0.01/0.13. **The ladder is populated, not null: `volume_fp` 36–294 contracts per rung (>570m 162, >575m 277, >595m 293, >600m 294), `open_interest_fp` up to 170; `volume_24h_fp` is 0.00 on every rung and the quotes are one-sided to the point of meaninglessness (>570m bid 0.63 / ask 0.99, >580m 0.19 / 0.99, >565m 0.79 / 0.99 — an 80-cent spread).** `updated_time` reads 2026-08-04 on every rung, but **that field is series metadata, not a quote timestamp, and is not evidence of when anything last traded** — the A16 audit showed the same field frozen at 2026-04-09 across 131 Kalshi Fed markets that carried 298,901 contracts of 24-hour volume (A16-18). What disqualifies this ladder is therefore the zero 24-hour volume, the 80-cent spreads, and above all the arithmetic: last prices imply FY26 ≈ 572–575m, i.e. 4Q26 ≈ 120–123m (−1.6 to +0.9% y/y) with 1H26 304.5m actual and 3Q26 ≈ 148m — a quarter no participant in this debate holds. Zero weight, on those three grounds. Revision 1's "volume and open interest null" read a non-existent field (A12-14, the same parser error as A01-04); the audit's own replacement reason ("the last trade pre-dates the 6 Aug print") rests on `updated_time` and is **rejected** here for the reason A16-18 gives | https://api.elections.kalshi.com/trade-api/v2/markets?status=open&limit=100&series_ticker=KXABNBA ([sources/kalshi_KXABNBA_open_20260917T075503Z.json](sources/kalshi_KXABNBA_open_20260917T075503Z.json)) | 2026-09-17 (quotes last updated 2026-08-04) | 2026-09-17 | no |
...
| Claim 10 rewritten: Kalshi fields `volume_fp` / `open_interest_fp` are populated (the revision-1 "null" was a parser error). The disqualifiers are `volume_24h_fp` 0.00, 80-cent bid/ask spreads, and an implied 4Q26 of 120–123m that nobody holds. The audit's own replacement reason — `updated_time` 2026-08-04 showing the last trade pre-dated the 6 Aug print — is **not adopted**: A16-18 found the same field frozen at 2026-04-09 across 131 Kalshi Fed markets with 298,901 contracts of 24-hour volume, so it is series metadata, not a quote stamp | A12-14 accepted in part; A16-18 | none (zero weight either way) |
