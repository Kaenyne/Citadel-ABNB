# Codex (gpt-6-astra) research audit — batch A11 (R06, R08, R09)
...
answer, which the harness saves to `docs/pitch-forecasts/audits/A11-research-audit.md`. No network access is assumed; if a
...
Read, in this order: `docs/pitch-forecasts/00_BRIEF.md`; the question blocks for R06, R08, R09 in `docs/pitch-forecasts/QUESTIONS.md`;
...
## Output format (saved as `docs/pitch-forecasts/audits/A11-research-audit.md`)
...
base rates you checked from the repo files; the response agent will save it as `audits/A11-reproduce.py`.
