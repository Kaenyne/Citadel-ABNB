# Codex (gpt-6-astra) research audit — batch A08 (F01, F02, F03, F04)
...
answer, which the harness saves to `docs/pitch-forecasts/audits/A08-research-audit.md`. No network access is assumed; if a
...
Read, in this order: `docs/pitch-forecasts/00_BRIEF.md`; the question blocks for F01, F02, F03, F04 in `docs/pitch-forecasts/QUESTIONS.md`;
...
## Output format (saved as `docs/pitch-forecasts/audits/A08-research-audit.md`)
...
base rates you checked from the repo files; the response agent will save it as `audits/A08-reproduce.py`.
