# Codex (gpt-6-astra) research audit — batch A05 (C08, C11, C12)
...
answer, which the harness saves to `docs/pitch-forecasts/audits/A05-research-audit.md`. No network access is assumed; if a
...
Read, in this order: `docs/pitch-forecasts/00_BRIEF.md`; the question blocks for C08, C11, C12 in `docs/pitch-forecasts/QUESTIONS.md`;
...
## Output format (saved as `docs/pitch-forecasts/audits/A05-research-audit.md`)
...
base rates you checked from the repo files; the response agent will save it as `audits/A05-reproduce.py`.
