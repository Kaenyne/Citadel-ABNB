# Codex (gpt-6-astra) research audit — batch A06 (S01)
...
answer, which the harness saves to `docs/pitch-forecasts/audits/A06-research-audit.md`. No network access is assumed; if a
...
Read, in this order: `docs/pitch-forecasts/00_BRIEF.md`; the question blocks for S01 in `docs/pitch-forecasts/QUESTIONS.md`;
...
## Output format (saved as `docs/pitch-forecasts/audits/A06-research-audit.md`)
...
base rates you checked from the repo files; the response agent will save it as `audits/A06-reproduce.py`.
