...
|---|---|---|---|---|---|---|---|
| 01 | Repo census of margin-relevant inputs | fable | - | running | 23:55 | notes/01_input_census.md | 23:55 |
...
| 05 | Management statements v2 (all events incl. conferences) and 5 Nov guide-language pattern | fable | - | pending | | notes/05_mgmt_statements_v2.md | |
...
| M7 | Below-EBITDA bridge: SBC, D&A, interest income, tax, share count, EPS; FCF bridge; backtests | fable | 10 | pending | | notes/M7_below_ebitda.md | |
