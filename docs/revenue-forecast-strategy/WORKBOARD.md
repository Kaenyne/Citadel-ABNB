...
| WP-A | Thesis A backtest — kernel guide vs Street at 14 guide dates, executable returns | Krish | open | — | — | — | 2026-09-11 | `05_backtests/ALPHA_A_GUIDE_SURPRISE.md` |
...
| WP-B | Thesis B — kernel term structure vs FY consensus, 60-day revisions | Krish | blocked (WP-A harness; better with WP-G1) | — | — | — | 2026-09-11 | `05_backtests/ALPHA_B_TERM_STRUCTURE.md` |
...
| WP-D | λ control chart + backlog split into the pre-registration card (items F1–F4) | Krish | open (small) | — | — | — | 2026-09-11 | card rows |
