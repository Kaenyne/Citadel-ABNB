...
|---|---|---|---|---|---|---|---|---|
| WP-X | Regional kernel + origin–destination FX exposure matrix (R-engine `exposure.csv`); regional recompute of the FX carried through the kernel — supersedes the consolidated basket | Krish (O–D travel analysis) | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
| WP-R | Regional refresh using public arrivals and regional revenue inputs | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
| WP-K0 | Kernel engine module `kernel_engine_v1/` (PIT λ, kernel guide, term structure, control chart) — spine for Lane 1 | Krish | blocked (Gate 1 pytest failed; STOP) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [K0 STOP](05_backtests/K0_KERNEL_ENGINE.md) |
| WP-V | Valuation reconciliation page for decision WP-H (+0.48 turns/pt → FY27 band → price band vs football field vs branch analogues) | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
...
| WP-A | Thesis A backtest — kernel guide vs Street at 14 guide dates, executable returns | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
...
| WP-B | Thesis B′ — kernel term structure vs FY-guide revisions (free-data variant; FY consensus after WP-G1) | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
...
| WP-C3 | Retarget the 598 alt-data features + stays index at booked GBV and at the residual R | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
| WP-D | λ control chart + backlog split into the pre-registration card (items F1–F4) | Krish | blocked (Gate 1 STOP; not spawned) | Codex / Lane 1 parent | codex/lane1-full | 2026-09-12 | 2026-09-12 | [Lane 1 STOP log](05_backtests/LANE1_RUN_LOG.md) |
