...
| WP-H11 | Harness FORMAT 1.1 (`harness_v1_1/`): LIVE rows at the real run date, 2026Q4+ LIVE targets; W1/W2 rules and scores identical | Theo | done (13 Sep; Codex verifies at Lane 2 Gate 1) | Theo (Claude) | theo/lane2-kit | 2026-09-13 | 2026-09-13 | `harness_v1_1/README.md`, 37 tests |
| WP-RET | Executable next-open returns (`returns_v1/`): public OHLC, 23 letter events, `excess_open_{1,5,20,60}d` | Theo | done (13 Sep; Codex verifies at Lane 2 Gate 1) | Theo (Claude) | theo/lane2-kit | 2026-09-13 | 2026-09-13 | `returns_v1/README.md`, `earnings_reactions_open_v1.csv` |
| WP-A2 | Thesis A re-run under the harness convention (`lane2/CONVENTION.md`): kernel guide vs morning-of-print Street at 14 letters, next-open returns, GBV-surprise control | Krish | claimed · Codex (Lane 2 full, Gate 2) | Codex | codex/lane2-full | 2026-09-14 | 2026-09-13 | `alpha_a2/`, `05_backtests/ALPHA_A2_GUIDE_SURPRISE_V2.md` |
| WP-B2 | Thesis B′ free-data version: kernel term structure vs next-quarter consensus revision and FY-guide bucket change; registers q+2 revenue | Krish | claimed · Codex (Lane 2 full) | Codex | codex/lane2-full | 2026-09-14 | 2026-09-13 | `alpha_b2/`, `05_backtests/ALPHA_B2_TERM_STRUCTURE_V2.md` |
...
| WP-F | Wire RNPL as a variable (u, L, re-based nights, λ chart, funds-payable score line) + FX-confound check | Theo | claimed · Codex (Lane 2 full) | Codex | codex/lane2-full | 2026-09-14 | 2026-09-13 | `rnpl_v2/`, `05_backtests/ALPHA_F_RNPL.md` |
...
| WP-C2 | Macro / arrivals pulls (NTTO, Eurostat, JNTO, INE, DATATUR, ISTAT, STR weekly, CPI) → covariates | Theo | claimed · Codex (Lane 2 full) | Codex | codex/lane2-full | 2026-09-14 | 2026-09-13 | `macro_pulls/` + manifest, `05_backtests/C2_MACRO_PULLS.md` |
...
| WP-L | Airbnb policy monitor (RNPL, fees, cancellation) — weekly fetch + diff, dated log | Theo | claimed · Codex (Lane 2) — **only if Theo sets SANCTIONED_BY_THEO: yes in lane2/L_POLICY_MONITOR.md** | Codex | codex/lane2-full | — | 2026-09-13 | `data/manifests/policy_monitor.log` |
| WP-M | Consensus re-stamp weekly + 2–3 Nov (Zacks nights/ADR/GBV) | Theo | claimed · Codex (Lane 2 full) | Codex | codex/lane2-full | 2026-09-14 | 2026-09-13 | vintage register rows |
