...
The analytical final commit `da3769e436676f6a84d58252b959533455debc3c` is pushed to shared `Kaenyne/Citadel-ABNB`, branch `codex/lane1-full`. A virtual merge against fetched `main` at `cde896a` is clean. GitHub PR creation was attempted with this complete body and rejected by the integration with **403: Resource not accessible by integration**; no PR was created. The CLI `gh` is unavailable. This is the only remaining publication step. [Open the user-specified comparison fallback](https://github.com/Kaenyne/Citadel-ABNB/compare/main...codex/lane1-full) and use this file as the prepared PR body. [Publication receipt](https://github.com/Kaenyne/Citadel-ABNB/blob/codex/lane1-full/data/processed/forecast_methods/lane1_control_v2/publication_receipt.json).
