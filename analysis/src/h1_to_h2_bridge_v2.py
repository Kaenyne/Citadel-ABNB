...
OUT = os.path.join(ROOT, 'data', 'processed', 'h2_bridge_v2')
...
fxline.to_csv(os.path.join(OUT, 'h2_bridge_v2_fx_line.csv'), index=False)
...
delta.to_csv(os.path.join(OUT, 'h2_bridge_v2_vs_v1_delta.csv'), index=False)
