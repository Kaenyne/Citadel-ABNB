...
Run: python analysis/src/q3nowcast_v2/E/V3_build_index.py
WP-K 2023-vintage copy of E4 (unchanged logic): reads/writes the v2 folder, where market_vintage_monthly.csv
carries the Mar-May 2023 vintages beside the held ones; the wedge table gains the 2023-vs-2025/2026 pairs,
the latest-vintage index outputs are unchanged by construction.
"""
import time
