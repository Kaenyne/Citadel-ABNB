...
def main():
    ...
    if args.predictions:
        ...
        merged=origins.merge(preds,left_on=["release_origin_date","last_reported_quarter","target","horizon_quarters"],right_on=["origin_date","last_reported_quarter","target","horizon_quarters"],suffixes=("","_forecast"),validate="one_to_many")
