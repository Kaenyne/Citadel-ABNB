...
def main():
    ...
    heading(fig, "Three future guides still rely on forecast inputs", "As of 15 September 2026; latest company actuals published 6 August. Q3 guidance is already issued.",
    ...
    heading(fig, "Better future GBV could reduce forecast error", "The perfect-input diagnostic shows potential. The tested flight repair does not deliver it.",
