"""Tests for harness FORMAT 1.1 -- the frozen 1.0 suite, re-pointed at the copy (must stay green).

  python -m pytest \
      analysis/src/forecast_methods/harness_v1_1/tests -q
"""
...
from harness_v1_1.registry import (RegistryError, StreetVintageError,
                              validate_registry_frame, REQUIRED_COLUMNS)
from harness_v1_1.baselines import baseline_street
