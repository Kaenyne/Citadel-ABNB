        ...
        for window in windows:
            for object_name, target, point, extra in [
                ...
                records.append(dict(method=METHOD, object=object_name, target=target,
                    ...
                    notes=f'Rejected research candidate retained; prior release origin before guide; '
...
def main():
    ...
    receipt['rows_by_object_window'] = {f'{key[0]}/{key[1]}': val for key, val in receipt['rows_by_object_window'].items()}
