...
def build(out):
    ...
    for p in panels:
        ...
        header = dict(panel_family=p['panel_family'], vendor=p['vendor'], observed_timestamp=p['observed_timestamp'],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out',type=Path,default=PKG/'expectations_v1')
