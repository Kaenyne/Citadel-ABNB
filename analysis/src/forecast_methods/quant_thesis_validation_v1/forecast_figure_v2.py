...
if __name__=='__main__':
    p=argparse.ArgumentParser();p.add_argument('--source',type=Path,default=PKG/'prospective_v1/results_v1/evaluation/scores.csv');p.add_argument('--out',type=Path,default=PKG/'figures_forecast_v2')
