"""adr_engine_v3 / config.py — paths, frozen constants and the pre-registered pass lines for the ADR line v1.
...
OUT = ROOT / "data/processed/pitch_model_v2/adr_engine_v3"          # v3 writes only here (copy, never overwrite)
SEED_FROM = ROOT / "data/processed/pitch_model_v2/adr_engine"      # adr_engine (v2) outputs: frozen inputs, read-only
SEED_FILES = ["fx_daily_2026-09-21.csv", "fx_fetch_manifest_2026-09-21.csv", "stays_yoy_by_country_vmatch.csv",
              "country_price_levels_usd.csv", "market_currency_map.csv", "market_price_levels_capture_2026.csv",
              "od_geo_mix_measured_tilt.csv", "fx_beta_draws.npy", "fx_weights_posterior.csv",
              "fx_daily_extra_2026-09-22.csv", "fx_daily_ecb_peg_2026-09-22.csv"]
FIG = ROOT / "docs/pitch-model-v2/lines/figures/v3"
