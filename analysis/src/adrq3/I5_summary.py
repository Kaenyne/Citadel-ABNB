...
Selection rules (fixed before the outputs were read):
  ...
  LOS mix        point = median of the 2026 global 10-K-weighted rows (Jun and Aug pairs, all
                 windows, occupancy-weighted); lo/hi = min/max over windows x weighting
...
def main():
    ...
    rows.append(dict(term="unit_size_party_size", quarter="3Q26_to_date", **{"3Q26_to_date_value": pt.accommodates_mean_yoy_pct},
    ...
    for w, cons, lab in [("2q26", "vmatch", "2Q26"), ("3q25_to_date", "oldvintage", "3Q25_to_date"), ("3q25_full", "within", "3Q25_full")]:
        ...
        if len(s):
            s = s.iloc[0]
            rows.append(dict(term="unit_size_party_size", quarter=lab, **{"3Q26_to_date_value": s.accommodates_mean_yoy_pct},
    ...
    rows.append(dict(term="unit_size_party_size", quarter="3Q26 (H card)", **{"3Q26_to_date_value": 1.25}, unit="booked capacity y/y pct (13 base case)",
    ...
    pt = float(occ.los_mix_pp.median())
    d28 = float(occ.d_share_ge28_pp.median())
    rows.append(dict(term="los_mix", quarter="3Q26_to_date", **{"3Q26_to_date_value": d28},
    ...
    rows.append(dict(term="geo_mix", quarter="3Q26_to_date",
    ...
    df = df[["term", "quarter", "3Q26_to_date_value", "unit", "adr_contribution_pp", "lo", "hi", "basis", "evidence_status", "source_file"]]
